  ...
  render() {
    ...
    el.innerHTML = `
      ...
      <div class="action-row fade-in">
        <button class="btn btn-primary" id="btnAddRoMazava">+ Ajouter un ro mazava</button>
      </div>
      ${
        list.length === 0
    ...
    document.getElementById("btnAddRoMazava").addEventListener("click", () => {
      LAOKA_FORM_UI.draft = LAOKA_FORM_UI.emptyDraft();
      LAOKA_FORM_UI.draft.dishCategory = "ro_mazava";
      LAOKA_FORM_UI.draft.dishSubCategory = "ro_mazava"; // cohérent avec saveDraftAsRecipe (dérive dishCategory de dishSubCategory)
