...
const DEFAULT_PRODUCTS = [
  ...
  /* ---- Goûter (tacos/burger/sandwich) — produits ajoutés pour peupler la nouvelle catégorie
     dishCategory "gouter" (dashboard Laoka, cadres par défaut). Aucun équivalent existant. ---- */
  { id: "pain_burger", name: "Mofo burger (pain burger)", category: "cereales", unit: "piece", basePrice: 1500 },
  { id: "pain_sandwich", name: "Mofo sandwich (pain de mie)", category: "cereales", unit: "piece", basePrice: 400 },
  { id: "galette_tacos", name: "Galette tacos", category: "cereales", unit: "piece", basePrice: 700 },
  { id: "fromage", name: "Fromage (fondu/tranché)", category: "autres", unit: "kg", basePrice: 22000 },
  { id: "hena_hachee", name: "Hena hachée (bœuf haché)", category: "viandes", unit: "kg", basePrice: 19000, ingredientType: "hena", animalSource: "boeuf" },
  { id: "sauce_tacos", name: "Sauce tacos/burger", category: "autres", unit: "kg", basePrice: 9000 },
];;
...
const DISH_CATEGORY_LABELS = {
  ...
  // Ajouté (dashboard Laoka, cadres par défaut) : purées/plats pour bébé — catégorie entièrement
  // nouvelle, distincte de hanikotrana (mangahazo/vomanga/saonjo nature) et de gouter (ci-dessous).
  bebe: "Bébé (purées & plats bébé)",
  // Ajouté (dashboard Laoka, cadres par défaut) : tacos/burger/sandwich — distinct de hanikotrana
  // (qui reste "mangahazo/vomanga/saonjo nature") et de bebe (baby food).
  gouter: "Goûter (tacos, burger, sandwich...)",
};
...
const DEFAULT_RECIPES = [
  ...
  /* ---- BÉBÉ (purées / plats bébé) — nouvelle catégorie (dashboard Laoka, cadres par défaut).
     Recettes de démonstration, sur le modèle des recettes hanikotrana existantes : simples,
     sans épices fortes ni sel excessif, cuisson vapeur/bouillie. ---- */
  {
    id: "r69", name: "Purée vomanga bébé", photo: "🍠", type: "LEGUMES", dishCategory: "bebe",
    dishSubCategory: "bebe", foodRole: "laoka",
    ingredientType: "legumes", moment: ["maraina", "atoandro"],
    time: 20, servings: 2, diet: ["standard", "halal", "mpino", "sabatista", "vegetarien"], containsPork: false,
    certaintyLevel: "TRADITIONNEL",
    source: "Pattern culinaire de base pour purée bébé (vomanga bouilli puis écrasé, sans sel ajouté) — non vérifié individuellement par recherche web dans cette passe d'audit.",
    ingredients: [
      { productId: "vomanga", qty: 0.25, unit: "kg" },
    ],
    steps: ["Diovina ny vomanga.", "Ahandroina amin'ny rano mandra-malemy tsara.", "Totoina ho lasa purée, alamino tsara alohan'ny fanomezana."],
  },
  {
    id: "r70", name: "Purée saonjo sy anana bébé", photo: "🍠", type: "LEGUMES", dishCategory: "bebe",
    dishSubCategory: "bebe", foodRole: "laoka",
    ingredientType: "legumes", moment: ["maraina", "atoandro"],
    time: 25, servings: 2, diet: ["standard", "halal", "mpino", "sabatista", "vegetarien"], containsPork: false,
    certaintyLevel: "TRADITIONNEL",
    source: "Pattern culinaire de base pour purée bébé (saonjo + anana bouillis, sans sel ajouté) — non vérifié individuellement par recherche web dans cette passe d'audit.",
    ingredients: [
      { productId: "saonjo", qty: 0.2, unit: "kg" },
      { productId: "anana", qty: 0.1, unit: "bunch" },
    ],
    steps: ["Diovina ny saonjo sy ny anana.", "Ahandroina miaraka mandra-malemy tsara.", "Totoina ho lasa purée manify, alamino tsara alohan'ny fanomezana."],
  },
  {
    id: "r71", name: "Bouillie vary sy atody bébé", photo: "🍚", type: "LEGUMES", dishCategory: "bebe",
    dishSubCategory: "bebe", foodRole: "laoka",
    ingredientType: "atody", moment: ["maraina"],
    time: 25, servings: 2, diet: ["standard", "halal", "mpino", "sabatista"], containsPork: false,
    certaintyLevel: "TRADITIONNEL",
    source: "Pattern culinaire de base pour bouillie bébé (riz très cuit + jaune d'œuf, sans sel ajouté) — non vérifié individuellement par recherche web dans cette passe d'audit.",
    ingredients: [
      { productId: "vary_fotsy", qty: 0.1, unit: "kg" },
      { productId: "atody", qty: 1, unit: "piece" },
    ],
    steps: ["Ahandroina ny vary amin'ny rano be, mandra-mitovy amin'ny lasopy matevina.", "Aharoina ny atody voavily kely.", "Ahandroina indray kely, alamino tsara alohan'ny fanomezana."],
  },

  /* ---- GOÛTER (tacos / burger / sandwich) — nouvelle catégorie (dashboard Laoka, cadres par
     défaut), distincte de hanikotrana (mangahazo/vomanga/saonjo nature). Recettes de démonstration
     sur le modèle des recettes hanikotrana existantes. ---- */
  {
    id: "r72", name: "Burger hena hachée", photo: "🍔", type: "GRILLE", dishCategory: "gouter",
    dishSubCategory: "gouter", foodRole: "laoka",
    ingredientType: "hena", moment: ["atoandro", "hariva"],
    time: 25, servings: 2, diet: ["standard"], containsPork: false,
    certaintyLevel: "A_VERIFIER",
    source: "Recette de démonstration (goûter, non traditionnelle malgache) ajoutée pour peupler la nouvelle catégorie dishCategory=\"gouter\" — non vérifiée par recherche web.",
    ingredients: [
      { productId: "hena_hachee", qty: 0.3, unit: "kg" },
      { productId: "pain_burger", qty: 2, unit: "piece" },
      { productId: "fromage", qty: 0.06, unit: "kg" },
      { productId: "voatabia", qty: 0.1, unit: "kg" },
      { productId: "sauce_tacos", qty: 0.05, unit: "kg" },
      { productId: "sira", qty: 0.005, unit: "kg" },
    ],
    steps: ["Vongano ny hena hachée, asio sira, endaso na grilloa.", "Sokafy ny mofo burger, ampio fromage sy voatabia.", "Ahodino ny hena grillé, apetraho eo amin'ny mofo, asio sauce."],
  },
  {
    id: "r73", name: "Tacos hena", photo: "🌮", type: "GRILLE", dishCategory: "gouter",
    dishSubCategory: "gouter", foodRole: "laoka",
    ingredientType: "hena", moment: ["atoandro", "hariva"],
    time: 25, servings: 2, diet: ["standard"], containsPork: false,
    certaintyLevel: "A_VERIFIER",
    source: "Recette de démonstration (goûter, non traditionnelle malgache) ajoutée pour peupler la nouvelle catégorie dishCategory=\"gouter\" — non vérifiée par recherche web.",
    ingredients: [
      { productId: "hena_hachee", qty: 0.25, unit: "kg" },
      { productId: "galette_tacos", qty: 3, unit: "piece" },
      { productId: "fromage", qty: 0.05, unit: "kg" },
      { productId: "tongolo", qty: 0.05, unit: "kg" },
      { productId: "sauce_tacos", qty: 0.05, unit: "kg" },
      { productId: "sira", qty: 0.005, unit: "kg" },
    ],
    steps: ["Atono ny hena hachée miaraka amin'ny tongolo sy sira.", "Afanao kely ny galette tacos.", "Ampidiro ny hena, fromage, sauce ao anaty galette."],
  },
  {
    id: "r74", name: "Sandwich atody", photo: "🥪", type: "LEGUMES", dishCategory: "gouter",
    dishSubCategory: "gouter", foodRole: "laoka",
    ingredientType: "atody", moment: ["maraina", "atoandro"],
    time: 15, servings: 2, diet: ["standard", "halal", "mpino", "sabatista"], containsPork: false,
    certaintyLevel: "A_VERIFIER",
    source: "Recette de démonstration (goûter, non traditionnelle malgache) ajoutée pour peupler la nouvelle catégorie dishCategory=\"gouter\" — non vérifiée par recherche web.",
    ingredients: [
      { productId: "pain_sandwich", qty: 4, unit: "piece" },
      { productId: "atody", qty: 2, unit: "piece" },
      { productId: "fromage", qty: 0.04, unit: "kg" },
      { productId: "menaka", qty: 0.01, unit: "l" },
      { productId: "sira", qty: 0.005, unit: "kg" },
    ],
    steps: ["Atono ny atody voavily amin'ny menaka sy sira.", "Apetraho eo amin'ny mofo sandwich, ampio fromage.", "Akatony ny mofo, tapaho roa."],
  },
];;
...
const MEASURE_UNITS = ["kg", "g", "l", "ml", "piece", "bunch", "kapoaka", "tsongo", "madco", "tanana", "toko"];
const UNIT_LABELS = {
  kg: "kg", g: "g", l: "L", ml: "ml",
