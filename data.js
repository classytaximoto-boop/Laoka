...
const DEFAULT_PRODUCTS = [
  ...
  /* Patsa-be maina/sec (crevette séchée) — distinct du Patsa frais ci-dessus (audit prompt final, section 2/9).
     Existe en deux variétés (patsa mena rouge / patsa fotsy blanc) ; "patsa_be" couvre la forme générique
     utilisée dans les recettes (ovy sy patsa be, ravimbomanga sy patsa be...). Sources : blogs cuisine
     malgache (ranouraii.wordpress.com, sakafogasy.blogspot.com) — niveau TRADITIONNEL. */
...
const DEFAULT_RECIPES = [
  ...
  /* ---- HANIKOTRANA — mangahazo/vomanga/saonjo mangés nature (bouillis/vapeur), en collation ou
     goûter, sans laoka ni sauce d'accompagnement. Distinct des recettes laoka existantes qui
     utilisent ces mêmes produits comme ingrédient d'un vrai plat (ex. r09 "Mangahazo maina sy
     trondro", r13 "Vomanga sy atody") — celles-ci restent des laoka, pas des hanikotrana. ---- */
  {
  ...
  /* Romazava — plat national malgache, manquait de la base malgré son statut d'exemple explicite
     du prompt final (section 4). Sources concordantes (recettes-papounet.com, artsdelices.com,
     nkosiagro.com, africa-cuisine.com) : bœuf mijoté longuement, brèdes mafana (anamamy/anamalao)
     ajoutées en fin de cuisson, oignon, tomate, gingembre, sel — niveau CONFIRME. */
  {
