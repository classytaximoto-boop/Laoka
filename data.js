...
const LAOKA_KIND = ["VOAMAINA", "VOALENA", "HENA", "TRONDRO", "LEGUMES", "LASOPY", "ATODY", "VORONA", "ANANA"];
...
/* Sous-état du Trondro : maina (sec) ou lena (frais) — affiché seulement quand TRONDRO est choisi. */
