...
const DEFAULT_PRODUCTS = [
  ...
  { id: "voatabia",   name: "Voatabia (tomate)",  category: "legumes",      unit: "kg",   basePrice: 4000, ingredientType: "legumes" },
  { id: "tongolo",    name: "Tongolo (oignon)",   category: "legumes",      unit: "kg",   basePrice: 4300, ingredientType: "legumes" },
  ...
  { id: "voanjo",     name: "Voanjo (arachide)",  category: "legumineuses", unit: "kg",   basePrice: 6500, ingredientType: "voamaina" },
  ...
  { id: "lasary",     name: "Karoty (carotte)",   category: "legumes",      unit: "kg",   basePrice: 3000, ingredientType: "legumes" },
  { id: "kobasira",   name: "Kobasira (petits pois)", category: "legumes", unit: "kg", basePrice: 4800, ingredientType: "legumes" },
  ...
  /* ---- Ambany tanana (abats et laoka populaires) — catégorie indépendante de Hena (audit prompt 1/4) ---- */
  ...
  /* ---- Ambany tanana — complétion (prompt 3/4, section 2) : une partie animalPart + animalSource
     par produit, jamais de catégorie séparée par combinaison (règle explicite du prompt).
     Format "Nom malgache (français)" — le nom malgache n'est jamais remplacé par sa traduction.
     Lohany/Tongony combinés à omby/kisoa/ondry selon les formes données par le prompt :
     Lohan'omby, Lohan-kisoa, Lohan'ondry, Tongon'omby, Tongon-kisoa, Tongon'ondry. ---- */
  ...
  /* ---- Poisson de mer / hazandranomasina (audit prompt 1/4 : séparé de trondro/hazandrano) ---- */
  { id: "gogo",       name: "Gogo",               category: "hazandranomasina", unit: "kg", basePrice: 9500, ingredientType: "hazandranomasina" },

  /* ---- Fruits de mer — catégorie indépendante des poissons (audit prompt 1/4) — prix indicatifs ---- */
  ...
  /* ---- Trondro maina (poisson d'eau douce séché) — prix indicatifs, fourchette 8000-15000 Ar/kg selon variété ---- */
  { id: "trondro_maina_fony",      name: "Trondro maina fony",      category: "hazandrano", unit: "kg", basePrice: 9000, ingredientType: "hazan_drano" },
  { id: "trondro_maina_gogo",      name: "Trondro maina gogo",      category: "hazandrano", unit: "kg", basePrice: 8500, ingredientType: "hazan_drano" },
  { id: "trondro_maina_karapapaka", name: "Trondro maina karapapaka", category: "hazandrano", unit: "kg", basePrice: 12000, ingredientType: "hazan_drano" },
  { id: "trondro_maina_maiky",     name: "Trondro maina maiky (tilapia séché)", category: "hazandrano", unit: "kg", basePrice: 10000, ingredientType: "hazan_drano" },
  ...
  /* ---- Special Boucher — découpes/préparations bouchères, catégorie indépendante de Hena
     (audit prompt 1/4, section 13 : sosety/saosisy sont des préparations, pas des viandes brutes) ---- */
  { id: "sosety",     name: "Sosety (saucisse)",   category: "special_boucher", unit: "kg", basePrice: 9500, ingredientType: "special_boucher", animalSource: "porc" },
  { id: "saosisy",    name: "Saosisy (saucisson)", category: "special_boucher", unit: "kg", basePrice: 11000, ingredientType: "special_boucher", animalSource: "porc" },

  /* ---- Vorona additionnels (prompt 2/4) — nécessaires pour les compatibilités cuisson traditionnelles
     "Gana + Ritra" et "Dinde + Ritra" citées explicitement dans le prompt. Prix indicatifs. ---- */
  ...
  /* ---- Fety — produits manquants pour couvrir la sélection de fête (prompt 3/4, section 1) ----
     Fety n'est pas un groupe alimentaire : ces produits restent classés dans leur catégorie
     habituelle (hena/vorona/hazandranomasina/legumes...), Fety n'étant qu'une sélection de recettes
     (voir DEFAULT_RECIPES, champ isFety). Prix indicatifs. ---- */
  ...
  /* ---- COMPLÉTION (prompt 3/4, section 3) — aliments malgaches manquants réellement pertinents.
     Ajoutés uniquement quand le terme est confirmé ; toute variété locale incertaine est marquée
     "A VERIFIER" dans son commentaire plutôt qu'inventée (règle explicite du prompt). ---- */
  // Anana — variétés courantes distinctes de l'anana générique déjà présent, toutes ingredientType "anana"
  ...
  // Poisson de mer — vorogne, courant sur les marchés malgaches, distinct de gogo
  { id: "vorogne",    name: "Vorogne", category: "hazandranomasina", unit: "kg", basePrice: 10000, ingredientType: "hazandranomasina" },
  // Épices/aromates manquants — vanille et cannelle, très utilisées dans la cuisine malgache de fête
  ...
  // Cubes bouillon — marques confirmées vendues à Madagascar (Jumbo, Maggi ; voir BOUILLON_CUBE_REFERENCE
  // pour la logique complète). unit "piece" = 1 cube à l'unité. PRIX A VERIFIER : aucune source de marché
  // malgache fiable trouvée pour le prix au cube (contrairement aux autres prix "indicatifs" du fichier,
  // basés sur une estimation de marché même approximative) — 500 Ar est un plancher donné par l'utilisateur,
  // pas un prix de marché confirmé. A corriger avec un vrai prix dès que disponible.
...
const DISH_CATEGORIES = [
  "laoka_classique", "rony", "ritra", "ketsaketsa", "saosy", "kiendy", "kitono",
  "voamaina", "voalena", "ambany_tanana", "achard", "ro_mazava", "ro_matsatso",
];
...
const DISH_CATEGORIES_SEARCH = ["laoka_classique", "rony", "ritra", "ketsaketsa", "saosy", "kiendy", "kitono"];
...
const DEFAULT_RECIPES = [
  ...
  /* ============================================================
     FETY — sélection spéciale pour fêtes et grandes occasions (prompt 3/4, section 1)
     isFety: true + festiveOccasions: [...] (voir FETY_OCCASIONS). dishCategory reste normal
     ("laoka" ou "ambany_tanana") : Fety est une sélection, pas un groupe alimentaire séparé.
     ============================================================ */
  {
  ...
  {
    id: "r44", name: "Akoho rôti", photo: "🍗", type: "ROTI", dishCategory: "laoka",
    ...
    steps: [
      ...
      "Endasina any am-patana mandra-masaka tsara sy mivolon-mena ny hoditra.",
    ],
  },
  {
  ...
  {
    id: "r51", name: "Brochettes", photo: "🍢", type: "GRILLE", dishCategory: "laoka",
  ...
  {
    id: "r52", name: "Poisson grillé", photo: "🐟", type: "GRILLE", dishCategory: "laoka",
  ...
  {
    id: "r53", name: "Crevettes", photo: "🦐", type: "GRILLE", dishCategory: "laoka",
  ...
  {
    id: "r54", name: "Langouste", photo: "🦞", type: "GRILLE", dishCategory: "laoka",
    dishSubCategory: "laoka_classique", foodRole: "laoka", ingredientType: "fruits_de_mer",
  ...
  {
    id: "r55", name: "Salade composée", photo: "🥗", type: "LEGUMES", dishCategory: "laoka",
  ...
  {
    id: "r56", name: "Pommes de terre fêtes", photo: "🥔", type: "LEGUMES", dishCategory: "laoka",
    dishSubCategory: "laoka_classique", foodRole: "laoka", ingredientType: "legumes",
    isFety: true, festiveOccasions: ["noel", "taombaovao", "mariazy", "reception"],
    moment: ["atoandro", "hariva"], time: 30, servings: 6,
    diet: ["standard", "halal", "mpino", "sabatista", "vegetarien"], containsPork: false,
  ...
  {
    id: "r57", name: "Légumes sautés fêtes", photo: "🥦", type: "KETSAKETSA", dishCategory: "laoka",
  ...
  /* ---- COMPLÉTION (prompt 3/4, section 3) — laoka manquants utilisant les nouveaux produits ---- */
  {
...
const COOKING_COMPATIBILITY = [
  ...
  { productId: "gana", mode: "KIENDY", status: "compatible" },
  ...
  { productId: "akoho", mode: "KIENDY", status: "compatible" },
...
const SHELF_LIFE_DAYS = {
  ...
  hazandrano: 2, // poisson d'eau douce frais — trondro_maina (séché) a une durée de vie réelle bien
  // plus longue, mais reste dans cette catégorie de stockage ; à affiner plus tard si besoin.
...
/* "Atao" (mode de cuisson) — étend l'ancien enum type avec VOAMAINA (légumineuses séchées),
   puis avec les modes du prompt 2/4 (cuissons/épices/compatibilités). KIENDY est CONSERVÉ tel
   quel (aucun renommage) : c'est l'orthographe déjà utilisée dans ce projet pour "Miendy" demandé
   par le prompt 2 — on ne duplique donc pas un mode MIENDY séparé, voir COOKING_MODES_DETAIL.kiendy
   pour la note de correspondance. MAIN, SAOSY, LASOPY, LEGUMES, POISSON, VIANDE, ATODY, VOAMAINA
   restent des modes historiques du projet, non listés explicitement dans le prompt 2 mais conservés
   (le prompt ne demande jamais d'en supprimer). STANDARD ajouté en tête (prompt 2, liste MODES A
   PREVOIR) : cuisson simple par défaut, sans procédé particulier. */
const DISH_COOKING_MODES = [
  "STANDARD", "RITRA", "RONY", "KETSAKETSA", "KIENDY",
...
const COOKING_MODE_LABELS = {
  STANDARD: "Standard", RITRA: "Ritra", RONY: "Rony", KETSAKETSA: "Ketsaketsa", KIENDY: "Kiendy (Miendy)",
...
/* ---------- 4b-bis. CUISSONS — FICHE DETAILLEE (prompt 2/4) ----------
   ...
   différents (ex : Akoho gasy -> RITRA, Akoho gasy -> RONY, Akoho gasy -> KIENDY sont tous valides).
...
const COOKING_MODES_DETAIL = {
  ...
  KIENDY: {
    name: "Kiendy (Miendy)",
    fr: "Version condensée / réduite en sauce épaisse",
    description: "Cuisson prolongée jusqu'à réduction quasi complète de la sauce, texture épaisse et concentrée.",
    compatibleTypes: ["hena", "vorona", "voamaina"],
    commonIngredients: ["tongolo", "sira", "menaka"],
    restrictions: "Nécessite un temps de cuisson long ; peu adapté aux anana fragiles qui se déliteraient.",
  },
  NAHANDRO_GASY: {
    name: "Nahandro gasy",
