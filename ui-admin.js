...
const ADMIN = {
  ...
  openProductForm(existing) {
    ...
    document.querySelectorAll("#prCompatibleTypes .choice-chip, #prIncompatibleTypes .choice-chip, #prCookable .choice-chip, #prNotCookable .choice-chip, #prSauce .choice-chip")
