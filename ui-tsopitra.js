...
const CATEGORY_ICONS = {
  legumes: "🥬", viandes: "🥩", poissons: "🐟", atody: "🥚",
  huiles: "🛢️", epices: "🌶️", cereales: "🌾", legumineuses: "🫘", autres: "📦",
};
...
const TSOPITRA_UI = {
  ...
  unitLabel(unit) {
    return { kg: "kg", l: "L", piece: "pièce(s)", bunch: "botte(s)", g: "g", ml: "ml" }[unit] || unit;
  },
  ...
  openPantryForm(existing) {
    ...
    const html = `
      ...
      <form id="pantryForm" class="form">
        ...
        <div class="field-row">
          <div class="field">
            <label for="pfQty">Quantité</label>
            <input type="number" id="pfQty" min="0.01" step="0.01" value="${existing ? existing.qty : 1}" required>
          </div>
          <div class="field">
  ...
  openNovidyForm() {
    ...
    const html = `
      ...
      <form id="novidyForm" class="form">
        ...
        <div class="field-row">
          <div class="field">
            <label for="nfQty">Quantité</label>
            <input type="number" id="nfQty" min="0.01" step="0.01" value="1" required>
          </div>
          <div class="field">
