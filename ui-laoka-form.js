...
const LAOKA_FORM_UI = {
  ...
  saveDraftAsRecipe() {
    ...
    // CORRIGÉ (audit final) : "ro_matsatso" est une sous-catégorie de ro_mazava (bouillon clair) —
    // sans ce cas, une recette Ro Matsatso ajoutée via RO_MAZAVA_UI atterrissait dans
    // DATA.state.recipes au lieu de DATA.state.roMazavaRecipes (elle n'apparaissait alors jamais
    // dans l'écran « Ro mazava », même si le moteur RECO la filtrait correctement par ailleurs).
