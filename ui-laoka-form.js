...
const LAOKA_FORM_UI = {
  ...
  renderComposition() {
    ...
    document.getElementById("compositionForm").addEventListener("submit", (e) => {
      ...
      this.draft = { name, photo: d.photo || "🍽️", productIds, type, moment, sauceProductIds, servings, notes: d.notes || "", dishSubCategoryOverride: d.dishSubCategoryOverride || null, isLasary: document.getElementById("compIsLasary").checked };
