...
const RECO = {
  ...
  getRecommendations(filters) {
    ...
    const scored = candidates.map((recipe) => {
      ...
      // à recipe.servings.
      let scaledToBuy = this.scaleCostForServings(cost.scalableToBuy, recipe.servings, filters.people, recipe) + cost.forfaitToBuy;
      let scaledConsumption = this.scaleCostForServings(cost.scalableConsumption, recipe.servings, filters.people, recipe) + cost.forfaitConsumption;
