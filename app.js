...
const CALC = {
  ...
  calculateRecipeCost(recipe, pantry, people, portionMode) {
    ...
    recipe.ingredients.forEach((ing) => {
      ...
      // Mode portion : uniquement pour les ingrédients protéinés, et seulement s'ils ne sont pas
      // en forfait (le forfait a sa propre logique de palier par personne, prioritaire).
      const isPortionAdjustable = portionMode && !isForfait && this.PROTEIN_INGREDIENT_TYPES.includes(product.ingredientType);
      const effectiveQty = isPortionAdjustable ? this.portionAdjustedKg(people, portionMode) : ing.qty;
